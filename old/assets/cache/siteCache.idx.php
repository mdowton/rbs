...
$c['use_editor'] = "1";
$c['use_browser'] = "1";
$c['rb_base_dir'] = "/home/naf/domains/naf.com.au/public_html/clients/rbs/";
$c['rb_base_url'] = "";
...
$c['show_preview'] = "0";
$c['filemanager_path'] = "/home/naf/domains/naf.com.au/public_html/clients/rbs/";
$c['theme_refresher'] = "";
$c['manager_layout'] = "4";
$c['custom_contenttype'] = "application/rss+xml,application/pdf,application/msword,application/excel,text/html,text/css,text/xml,text/javascript,text/plain";
$c['auto_menuindex'] = "1";
...
$m[] = array('0' => '1');
$d['2'] = 2;
$a[2] = array('id' => 2, 'alias' => '2', 'path' => '');
$m[] = array('0' => '2');
$d['3'] = 3;
$a[3] = array('id' => 3, 'alias' => '3', 'path' => '');
$m[] = array('0' => '3');
$d['4'] = 4;
$a[4] = array('id' => 4, 'alias' => '4', 'path' => '');
$m[] = array('0' => '4');
$d['5'] = 5;
$a[5] = array('id' => 5, 'alias' => '5', 'path' => '');
$m[] = array('0' => '5');
$d['6'] = 6;
$a[6] = array('id' => 6, 'alias' => '6', 'path' => '');
$m[] = array('0' => '6');
$d['7'] = 7;
$a[7] = array('id' => 7, 'alias' => '7', 'path' => '');
$m[] = array('0' => '7');
$d['8'] = 8;
$a[8] = array('id' => 8, 'alias' => '8', 'path' => '');
$m[] = array('0' => '8');
$d['9'] = 9;
$a[9] = array('id' => 9, 'alias' => '9', 'path' => '');
$m[] = array('3' => '9');
$d['10'] = 10;
$a[10] = array('id' => 10, 'alias' => '10', 'path' => '');
$m[] = array('3' => '10');
$d['11'] = 11;
$a[11] = array('id' => 11, 'alias' => '11', 'path' => '');
$m[] = array('3' => '11');
$d['12'] = 12;
$a[12] = array('id' => 12, 'alias' => '12', 'path' => '');
$m[] = array('3' => '12');
$d['13'] = 13;
$a[13] = array('id' => 13, 'alias' => '13', 'path' => '');
$m[] = array('3' => '13');
$d['24'] = 24;
$a[24] = array('id' => 24, 'alias' => '24', 'path' => '');
$m[] = array('4' => '24');
$d['25'] = 25;
$a[25] = array('id' => 25, 'alias' => '25', 'path' => '');
$m[] = array('4' => '25');
$d['26'] = 26;
...
$m[] = array('4' => '28');
$d['14'] = 14;
$a[14] = array('id' => 14, 'alias' => '14', 'path' => '');
$m[] = array('5' => '14');
$d['15'] = 15;
$a[15] = array('id' => 15, 'alias' => '15', 'path' => '');
$m[] = array('5' => '15');
$d['16'] = 16;
$a[16] = array('id' => 16, 'alias' => '16', 'path' => '');
$m[] = array('5' => '16');
$d['17'] = 17;
$a[17] = array('id' => 17, 'alias' => '17', 'path' => '');
$m[] = array('5' => '17');
$d['18'] = 18;
$a[18] = array('id' => 18, 'alias' => '18', 'path' => '');
$m[] = array('5' => '18');
$d['19'] = 19;
...
$m[] = array('6' => '20');
$d['21'] = 21;
$a[21] = array('id' => 21, 'alias' => '21', 'path' => '');
$m[] = array('6' => '21');
$d['22'] = 22;
$a[22] = array('id' => 22, 'alias' => '22', 'path' => '');
$m[] = array('6' => '22');
$d['23'] = 23;
$a[23] = array('id' => 23, 'alias' => '23', 'path' => '');
$m[] = array('6' => '23');
$c = &$this->contentTypes;
$c = &$this->chunkCache;
...
';
$c['opencube_outerTpl'] = '<ul id="qm0"[+wf.classes+]>
	[+wf.wrapper+]
</ul>';
$s = &$this->snippetCache;
$s['AjaxSearch'] = '/* -----------------------------------------------------------------------------
...
';
$p['QM+'] = 'include_once($modx->config[\'base_path\'].\'assets/plugins/qm/qm.inc.php\');
$qm = new Qm($modx, $jqpath, $loadmanagerjq, $loadfrontendjq, $loadtb, $usemm, $tbwidth, $tbheight, $hidefields, $addbutton, $tpltype, $tplid);';
$p['QM+Props'] = '&jqpath=Path to jQuery;text;assets/js/jquery-1.3.2.min.js &loadmanagerjq=Load jQuery in manager;list;true,false;false &loadfrontendjq=Load jQuery in front-end;list;true,false;true &loadtb=Load ThickBox in front-end;list;true,false;true &usemm=Use with ManagerManager plugin;list;true,false;true &tbwidth=ThickBox window width;int;800 &tbheight=ThickBox window height;int;500 &hidefields=Hide document fields from front-end editors;text;parent &addbutton=Show add document here button;list;true,false;true &tpltype=New document template type;list;parent,id,selected;parent &tplid=New document template id;int;3 ';
$p['TinyMCE'] = '/*
...
$p['TransAliasProps'] = '&table_name=Name;list;common,russian;common &override_tv=Override TV name;string; ';
$e = &$this->pluginEvent;
$e['OnBeforeManagerLogin'] = array('Forgot Manager Login');
$e['OnDocFormPrerender'] = array('Inherit Parent Template','QM+');
$e['OnDocFormRender'] = array('Image TV Preview');
$e['OnDocFormSave'] = array('QM+');
