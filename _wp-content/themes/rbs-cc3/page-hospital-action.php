                    ...
                    <div class="post">
                            <div class="action-picture">
                                ...
                                <div class="at-a-glance"></div>
                                 <h1>Use your mouse to find out more</h1>
...
(function($){
          ...
          $('.bubble.external-waterproofing').hover(
			  function(e) {	
			  	$(this).showBlurb("+=250px","-=250px");
			  }, function() {
				$(this).hideBlurb();
          ...
          $('.bubble.landscape-waterproof').hover(
			  function(e) {	
			  	$(this).showBlurb("+=250px","-=250px");
			  }, function() {
				$(this).hideBlurb();
          ...
          $('.bubble.concrete-roof-repair').hover(
			  function(e) {	
			  	$(this).showBlurb("+=250px","-=250px");
			  }, function() {
				$(this).hideBlurb();
          ...
          $('.bubble.gutter-maintenance').hover(
			  function(e) {	
			  	$(this).showBlurb("+=250px","-=250px");
			  }, function() {
				$(this).hideBlurb();
