...
<?php get_header(); ?>
                    ...
                    <div class="post">
                            ...
                            <a href="<?php bloginfo('url'); ?>/services/side-view/"> <img src="<?php bloginfo('template_directory');?>/images/side.png"/></a>
                              </div></div>                              
...
$(function() {
          ...
          $(".bubble").hide();
          $(".blurb").hide();
          $(".blurb.flash-seal").slideToggle();
          });
          
          $('.bubble.roof-repair').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.roof-repair").slideToggle();
          });
          
          $('.bubble.external-waterproofing').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.external-waterproofing").slideToggle();
          });
          
          $('.bubble.trafficable').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.trafficable").slideToggle();
          });
          
          $('.bubble.landscape-waterproof').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.landscape-waterproof").slideToggle();
          });  
          
          $('.bubble.building-waterproof').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.building-waterproof").slideToggle();
          });
          
          $('.bubble.concrete-roof-repair').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.concrete-roof-repair").slideToggle();
          });
          
          $('.bubble.window-sealing').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.window-sealing").slideToggle();
          });
          
          $('.bubble.penetration-sealing').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.penetration-sealing").slideToggle();
          });
          
          $('.bubble.gutter-maintenance').click(function(){
          $(".bubble").hide();
          $(".blurb").hide();    
          $(".blurb.gutter-maintenance").slideToggle();
          });
