...
class WpvEnqueues {
	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			...
			'addNewIcon' => __( 'Add New Icon', 'construction' ),
			'iconName'   => __( 'Icon', 'construction' ),
			'iconText'   => __( 'Text', 'construction' ),
			'iconLink'   => __( 'Link', 'construction' ),
			'iconChange' => __( 'Change', 'construction' ),
