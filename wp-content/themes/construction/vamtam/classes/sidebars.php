...
class WpvSidebars {
	...
	public function __construct() {
		$this->sidebars = array(
			'page' => __( 'Shared Page Widget Area', 'construction' ),
			'blog' => __( 'Blog Widget Area', 'construction' ),
			'portfolio' => __( 'Portfolio Widget Area', 'construction' ),
		);

		if ( wpv_has_woocommerce() )
			$this->sidebars['wpv-woocommerce'] = __( 'WooCommerce Widget Area', 'construction' );
