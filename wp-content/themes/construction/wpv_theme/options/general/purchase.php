...
array(
	'name' => __( 'Your Envato Username', 'construction' ) ,
	'id' => 'envato-username',
	'type' => 'text',
	'static' => true,
) ,
...
array(
	'name' => __( 'Your Envato API Key', 'construction' ) ,
	'desc' => sprintf( __( 'Do not share your API key with people you can\'t trust! Your API key gives them access to your purchased items. <a href="%s">See this page for a description of the Envato API and how to obtain an API key.</a>', 'construction' ), 'http://extras.envato.com/api/' ),
	'id' => 'envato-api-key',
	'type' => 'text',
	'static' => true,
) ,
...
<h5>Support</h5>
	If you have any questions that are beyond the scope of this help file, please feel free to <a href="%s">email us</a> or open a ticket in our <a href="%s">Help Desk</a>. You can <a href="%s">follow us on twitter</a> to get the updates. Thanks so much!', 'construction'), 'http://themeforest.net/licenses', 'mailto:support@vamtam.com', 'http://support.vamtam.com', 'https://twitter.com/vamtam' ),
	),
