...
array(
	'name'   => __( 'Favicon', 'construction' ),
	'desc'   => __( 'Upload your custom "favicon" which is visible in browser favourites and tabs. (Must be .png or .ico file - preferably 16px by 16px ). Leave blank if none required.', 'construction' ),
	'id'     => 'favicon_url',
	'type'   => 'upload',
	'static' => true,
),
